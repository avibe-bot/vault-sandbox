const STRINGS = {
  en: {
    ...
    "unlock.sessionTitle": "Unlock protected vault",
    "unlock.sessionSubtitle": "Unlock window: {{minutes}} min",
    "unlock.sessionBody": "Unlock this vault window. While unlocked, approvals use an in-sandbox confirmation instead of your passkey. Signing always requires your passkey.",
  ...
  zh: {
    ...
    "unlock.sessionTitle": "解锁保护档",
    "unlock.sessionSubtitle": "解锁窗口：{{minutes}} 分钟",
    "unlock.sessionBody": "解锁当前保险库窗口。解锁期间，授权只需要在沙箱里确认，不会反复要求 passkey。签名始终需要 passkey。",
